...
const InvalidConfigJSON = `{
	...
	"backendUrls": "https://invalid.backend.url",
...
func (s *VerifProxyTestSuite) SetupSuite() {
	...
	s.logger.Info("starting verified proxy")
	ctx, err := verifproxy.Start(logger, ValidConfigJSON)
...
func (s *VerifProxyTestSuite) TestMaxPriorityFeePerGas() {
	result, err := s.ctx.MaxPriorityFeePerGas()
...
func (s *VerifProxyTestSuite) TestGetBalance() {
	...
	result, err := s.ctx.GetBalance(address, blockTag)
...
func (s *VerifProxyTestSuite) TestGetStorageAt() {
	...
	result, err := s.ctx.GetStorageAt(address, slot, blockTag)
...
func (s *VerifProxyTestSuite) TestGetTransactionCount() {
	...
	result, err := s.ctx.GetTransactionCount(address, blockTag)
...
func (s *VerifProxyTestSuite) TestGetCode() {
	...
	result, err := s.ctx.GetCode(address, blockTag)
...
func (s *VerifProxyTestSuite) TestGetBlockByNumber() {
	result, err := s.ctx.GetBlockByNumber("latest", false)
...
func (s *VerifProxyTestSuite) TestGetBlockByHash() {
	...
	result, err := s.ctx.GetBlockByHash(s.testBlockHash, false)
...
func (s *VerifProxyTestSuite) TestGetUncleCountByBlockNumber() {
	result, err := s.ctx.GetUncleCountByBlockNumber("latest")
...
func (s *VerifProxyTestSuite) TestGetUncleCountByBlockHash() {
	...
	result, err := s.ctx.GetUncleCountByBlockHash(s.testBlockHash)
...
func (s *VerifProxyTestSuite) TestGetBlockTransactionCountByNumber() {
	result, err := s.ctx.GetBlockTransactionCountByNumber("latest")
...
func (s *VerifProxyTestSuite) TestGetBlockTransactionCountByHash() {
	...
	result, err := s.ctx.GetBlockTransactionCountByHash(s.testBlockHash)
...
func (s *VerifProxyTestSuite) TestGetTransactionByBlockNumberAndIndex() {
	result, err := s.ctx.GetTransactionByBlockNumberAndIndex("latest", 0)
...
func (s *VerifProxyTestSuite) TestGetTransactionByBlockHashAndIndex() {
	...
	result, err := s.ctx.GetTransactionByBlockHashAndIndex(s.testBlockHash, 0)
...
func (s *VerifProxyTestSuite) TestGetTransactionByHash() {
	...
	result, err := s.ctx.GetTransactionByHash(s.testTxHash)
...
func (s *VerifProxyTestSuite) TestGetTransactionReceipt() {
	...
	result, err := s.ctx.GetTransactionReceipt(s.testTxHash)
...
func (s *VerifProxyTestSuite) TestCall() {
	...
	result, err := s.ctx.Call(txArgs, blockTag, false)
...
func (s *VerifProxyTestSuite) TestCreateAccessList() {
	...
	result, err := s.ctx.CreateAccessList(txArgs, blockTag, false)
...
func (s *VerifProxyTestSuite) TestEstimateGas() {
	...
	blockTag := "latest"
	result, err := s.ctx.EstimateGas(txArgs, blockTag, false)
...
func (s *VerifProxyTestSuite) TestGetLogs() {
	...
	result, err := s.ctx.GetLogs(filterOptions)
...
func (s *VerifProxyTestSuite) TestNewFilter() {
	...
	result, err := s.ctx.NewFilter(filterOptions)
...
func (s *VerifProxyTestSuite) TestGetFilterLogs() {
	...
	result, err := s.ctx.GetFilterLogs(s.testFilterId)
...
func (s *VerifProxyTestSuite) TestGetFilterChanges() {
	...
	result, err := s.ctx.GetFilterChanges(s.testFilterId)
...
func (s *VerifProxyTestSuite) TestUninstallFilter() {
	...
	result, err := s.ctx.UninstallFilter(s.testFilterId)
...
func (s *VerifProxyTestSuite) TestGetBlockReceipts() {
	result, err := s.ctx.GetBlockReceipts("latest")
